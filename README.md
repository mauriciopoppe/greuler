...
```js
var d3 = window.d3
var functionPlot = require('greuler');
functionPlot({
  // options below
})
```
...
All the available options are described in the [`homepage`](http://maurizzzio.github.io/greuler/)
...
* `instance.linkedGraphs` {array} array of greuler instances linked to the events of this instance,
